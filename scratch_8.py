...
class Plotter:
    ...
    def draw_piecewise_linear_interpolation(self):
        ...
        self._setting_and_show(
            "Промежуточные значения для данных, полученные с использованием кусочно-линейного интерполирования")
    ...
    def draw_piecewise_parabolic_interpolation(self):
        ...
        self._setting_and_show(
            "Промежуточные значения для данных, полученные с использованием кусочно-параболического интерполирования")
